...
import mill.define.{Sources, Target, Task, Worker}
...
trait ScalaJSWebpackModule extends ScalaJSModule {
  ...
  def webpackWorker: Worker[SubProcess] = T.worker {
    os.proc(
        "node",
      ...
      .spawn(webpackOutputPath(), stdout = os.Inherit)
  }

  def webpackBundleFile: Sources = T.sources { webpackOutputPath() / webpackBundleFilename() }
